...
public class TabLayout extends HorizontalScrollView {
    ...
    public TabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TabLayoutUtils.checkAppCompatTheme(context);
    ...
    private void animateToTab(int newPosition) {
        ...
        if (startScrollX != targetScrollX) {
            if (mScrollAnimator == null) {
                mScrollAnimator = TabLayoutUtils.createAnimator();
        ...
        public TabView(Context context) {
            ...
            if (mTabBackgroundResId != 0) {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
                    setBackground(ContextCompat.getDrawable(context, mTabBackgroundResId));
                }
    ...
    private class SlidingTabStrip extends LinearLayout {
        ...
        void animateIndicatorToPosition(final int position, int duration) {
            ...
            if (startLeft != targetLeft || startRight != targetRight) {
                ValueAnimator animator = mIndicatorAnimator = TabLayoutUtils.createAnimator();
                ...
                animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                    ...
                    public void onAnimationUpdate(final ValueAnimator animator) {
                        ...
                        setIndicatorPosition(
                                TabLayoutUtils.lerp(startLeft, targetLeft, fraction),
                                TabLayoutUtils.lerp(startRight, targetRight, fraction));
                    }
                });
